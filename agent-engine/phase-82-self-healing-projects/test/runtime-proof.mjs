// Phase 82 runtime proof - phase-82-self-healing-projects
...
const os=new SelfHealingProjectsOS();
const s1=os.register({signal:'test-signal',requiresApproval:false});
check('SelfHealingProjectsOS registers signal',()=>assert.ok(s1&&s1.id));
