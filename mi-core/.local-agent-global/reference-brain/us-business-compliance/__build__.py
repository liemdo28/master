#!/usr/bin/env python3
"""US Compliance DB — Minimal Complete Generator. Run: python __build__.py"""
...
def section_block(domain, jdata, topic_code):
    """Generate2-3 sections based on domain."""
    out = []
    if domain == "tax":
        ...
        out.append("1. FOH: Hosting, serving, bartending, bussing 2. BOH: Cooking, prep, dishwashing, inventory 3. Management: Scheduling, ordering, reporting4. Admin: Payroll, accounting, marketing")
        out.append("")
