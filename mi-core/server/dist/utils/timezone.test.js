...
assert(timezone_1.STORE_TIMEZONES['Bakudan Ramen'].timezone === 'America/Chicago', 'Bakudan Ramen → America/Chicago');
assert(timezone_1.STORE_TIMEZONES['Raw Sushi Bar'].timezone === 'America/Los_Angeles', 'Raw Sushi Bar → America/Los_Angeles');
// ── TEST CASE: getTimeContextForAI includes owner primary ─────────────────
const ctx = (0, timezone_1.getTimeContextForAI)();
...
const dateInfo = (0, timezone_1.getOwnerDateInfo)();
