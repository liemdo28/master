...
exports.knowledgeRouter.post('/ingest', (_req, res) => {
    const result = (0, knowledge_db_1.fullIngest)();
    res.json({ ok: true, ...result });
});
exports.knowledgeRouter.post('/rebuild', (_req, res) => {
    const result = (0, knowledge_db_1.clearAndRebuild)();
    res.json({ ok: true, ...result });
});
exports.knowledgeRouter.post('/ingest-dir', (req, res) => {
...
exports.knowledgeRouter.post('/packs/install-all', (_req, res) => {
    res.json((0, pack_manager_1.installAllPacks)());
});
exports.knowledgeRouter.post('/packs/:packId/install', (req, res) => {
