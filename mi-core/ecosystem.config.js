...
module.exports = {
  apps: [
    // ── Accounting Engine (local API, port 8844) ─────────────────────────────
    {
      ...
      cwd: 'D:/Project/Master/mi-core/services/accounting-engine',
      instances: 1,
      exec_mode: 'fork',
      autorestart: true,
      watch: false,
      ...
      error_file: 'D:/Project/Master/.local-agent-global/logs/accounting-error.log',
      out_file:   'D:/Project/Master/.local-agent-global/logs/accounting-out.log',
    ...
    // ── Mi CEO Observer — Session A (CEO Main Account reader) ────────────────
    {
      ...
      script: 'src/index.js',
      cwd: 'D:/Project/Master/mi-core/services/mi-ceo-observer',
      instances: 1,
      exec_mode: 'fork',
      autorestart: true,
      watch: false,
      ...
      env: {
        NODE_ENV: 'development',
        CEO_SESSION_ROOT: 'D:/Project/Master/mi-core/services/mi-ceo-observer/data/ceo-session',
        CEO_CLIENT_ID: 'mi-ceo-observer',
        OBSERVER_PORT: '3212',
        MI_CORE_URL: 'http://127.0.0.1:4001',
        WHATSAPP_HEADLESS: 'true',
        LOG_DIR: 'D:/Project/Master/mi-core/services/mi-ceo-observer/logs',
        TASK_DETECTION_SENSITIVITY: '2',
        OBSERVE_PRIVATE_CHATS: 'true',
        OBSERVE_GROUPS: 'true',
      },
      error_file: 'D:/Project/Master/.local-agent-global/logs/ceo-observer-error.log',
      out_file:   'D:/Project/Master/.local-agent-global/logs/ceo-observer-out.log',
      log_date_format: 'YYYY-MM-DD HH:mm:ss',
      merge_logs: true,
    },
    ...
    // ── WhatsApp AI Gateway (CEO WhatsApp interface) ─────────────────────────
    {
      ...
      script: 'src/index.js',
      cwd: 'D:/Project/Master/mi-core/services/whatsapp-ai-gateway',
      instances: 1,
      exec_mode: 'fork',
      autorestart: true,
      watch: false,
      ...
      env: {
        ...
        AUTO_RECONNECT: 'true',
        MI_CORE_URL: 'http://127.0.0.1:4001',
        WHATSAPP_SESSION_ROOT: 'D:/Project/Master/mi-core/services/whatsapp-ai-gateway/data/whatsapp',
      },
      env_production: {
        NODE_ENV: 'production',
        PORT: '3211',
      ...
      error_file: 'D:/Project/Master/mi-core/services/whatsapp-ai-gateway/logs/pm2-err.log',
      out_file:   'D:/Project/Master/mi-core/services/whatsapp-ai-gateway/logs/pm2-out.log',
      log_date_format: 'YYYY-MM-DD HH:mm:ss',
      merge_logs: true,
    },
