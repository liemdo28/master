"""
generate_v3_bandera.py
Generates FoodSafety-Bandera-v3 print form.
...
FORM_ID    = "FoodSafety-Bandera-v3"
VERSION    = "v3.0"
STORE_NAME = "Bandera"
PREFIX     = "BAN"
OUT_FILE   = "FoodSafety-Bandera-LineCheck-v3.pdf"
...
def draw_footer(c, table_bottom_y):
    ...
    c.setFillColor(colors.HexColor("#555555"))
    line1 = (f"{FORM_ID}  |  Bakudan Ramen Group  |  Bandera Store  |  "
...
def build():
    ...
    c.setSubject("Food Safety Line Check -- Bandera v3")
