...
export default function NewBrandPage() {
  ...
  const [form, setForm] = useState({ name: '', slug: '', primary_color: '#C8102E', secondary_color: '#1A1A1A' });
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!res.ok) { setError('Failed to create brand'); return; }
    ...
    <div className="max-w-lg">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4">
        ...
        <div className="flex gap-3 pt-2">
          <button type="submit" className="bg-red-600 text-white px-5 py-2 rounded-lg text-sm font-medium hover:bg-red-700">Create Brand</button>
