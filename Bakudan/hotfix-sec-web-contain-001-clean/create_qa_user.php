 ...
 *
 * Usage:
 *   CLI:  php create_qa_user.php
 *   HTTP: https://preview.dashboard.bakudanramen.com/create_qa_user.php?key=qa-setup-2026
 *
 * Environment: PREVIEW ONLY. Will refuse to run on production.
 * REMOVE this file after QA user is created.
 */

$SECRET = 'qa-setup-2026';
