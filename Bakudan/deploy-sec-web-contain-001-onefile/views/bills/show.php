...
<div class="bill-detail-wrap">
    ...
    <div class="bill-detail-grid">
        ...
        <div class="bill-detail-card">
            ...
            <div class="bill-detail-value"><?= $dueDate ? e(date('M j, Y', strtotime($dueDate))) : '-' ?></div>
        </div>
        <div class="bill-detail-card">
                ...
                <div class="bill-linked-row">
                    <div>
                        ...
                        <div class="text-muted text-sm">
                            ...
                            <?php if (!empty($task['due_date'])): ?> · Due <?= e(date('M j', strtotime($task['due_date']))) ?><?php endif; ?>
                        </div>
                    </div>
                    <a class="btn btn-secondary btn-sm" href="<?= APP_URL ?>/tasks/<?= (int)$task['id'] ?>">Open / Edit Task</a>
                </div>
            <?php endforeach; ?>
