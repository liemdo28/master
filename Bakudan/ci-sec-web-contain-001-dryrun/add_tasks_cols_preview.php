<?php
/** add_tasks_cols_preview.php — Add 21 missing columns on preview (after asana_raw_json) */
...
$after = 'asana_raw_json';
$r=['ts'=>date('c'),'env'=>$_ENV['APP_ENV']??'unknown','after'=>$after,'added'=>[]];
...
$r['added'][]=addC($pdo,'task_notifications','inbox_category',"ALTER TABLE task_notifications ADD COLUMN inbox_category ENUM('task','review','approval','mention','system') NOT NULL DEFAULT 'task' AFTER metadata");
