...
host: process.env.DB_HOST || 'mysql-taskflow.bakudanramen.com',  user: process.env.DB_USER || 'liemdo',  password: process.env.DB_PASS || '',  database: process.env.DB_NAME || 'taskflow_db',
});
conn.connect();
