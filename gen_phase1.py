f=open(r'd:\Project\Master\mi-core\server\src\routes\qb-mirror-phase1.ts','w')
f.write("""/**
...
// GET /store-report — per-store P&L + BS + Cash detail
...
// GET /store-compare — all stores comparison grid
