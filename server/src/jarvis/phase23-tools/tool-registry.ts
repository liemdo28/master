...
const TOOLS: RegisteredTool[] = [
  ...
  { id: 'excel.create', name: 'Excel Create', description: 'Create Excel report', owner: 'mi-core', category: 'automation', risk: 0, approval_required: false, permissions: [], health: 'healthy', enabled: true },
